...
SLEEP_ROOM_TYPES = BEDROOM_TYPES | frozenset({STUDIO_TYPE})
N_BEDROOMS_DEPENDENT_ROOM_TYPES = frozenset({"living_kitchen", "living", "kitchen"})
HABITABLE_ROOM_TYPES = SLEEP_ROOM_TYPES | N_BEDROOMS_DEPENDENT_ROOM_TYPES
